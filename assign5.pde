...
void drawCaution(){								// Requirement #6
  for(int i = 0; i < soldierX.length; i++){ 
    if(getEnemyIndexByRow(playerRow+6)!=-1){
    image(caution,soldierX[getEnemyIndexByRow(playerRow+6)],soldierY[getEnemyIndexByRow(playerRow+6)]-80);
